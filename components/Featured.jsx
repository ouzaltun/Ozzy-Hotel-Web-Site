    ...
    >
      <div className="flex flex-col xl:flex-row items-center h-full gap-x-[30px] text-center xl-text-left">
        ...
        <p className="flex-1 text-soft_green leading-loose">
          ...
          omnis aperiam dolores eligendi explicabo, at id accusantium harum.
          Esse quam, commodi consequatur odit sequi quidem mollitia voluptatem
          voluptas accusantium incidunt!
        </p>
      </div>
    </motion.section>
  );
